"""Create a clean source ZIP; never bundle .venv, caches, or live output."""
...
FILES = [
    ...
    "start.py", "capture.py", "scrape.py", "build_release.py",
    ...
    "test/test_scrape.py", "test/test_capture.py", "test/test_start.py",
...
def main():
    ...
    archive = destination / f"Scrapper-Viva-{VERSION}-Mac-Windows-Linux.zip"
